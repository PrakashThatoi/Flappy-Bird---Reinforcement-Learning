...
class Agent():
    def __init__(self , param_set):
        ...
        with open("parameters.yaml" , "r") as f:
            ...
            params = all_params[self.param_set]
        ...
        self.reply_memory_size  = params['reply_memory_size']
        self.netework_sink_rate  = params['netework_sink_rate']
    ...
    def run(self , is_training = True , render = False):
        ...
        if is_training:
            memory = Replay_memory(self.reply_memory_size)
        ...
        for episode in itertools.count():
            ...
            if is_training:
                ...
                if best_reward < episode_reward:
                    log_msg = f"we have best reward {best_reward} for episode {episode+1}"
            ...
            if is_training and len(memory) > self.mini_batch_size:
                ...
                if step > self.netework_sink_rate :
                    target_dqn.load_state_dict(policy_dqn.state_dict())
                    step = 0 
        # manual closing
        # env.close()
    ...
    def optimize(self , mini_batch , policy_dqn , target_dqn):
        ...
        with torch.no_grad(): # if termination true target_q = reward
